...
Use these blocks selectively when composing Gemini 3 prompts.
...
Use when Gemini should act without asking routine questions.
...
Gemini 3 responds well to an explicit scratchpad tag.

```xml
<thinking>
Use this block to reason through the problem before writing the final answer.
Do not include the contents of this tag in the user-visible output.
</thinking>
```
